...
class commonDashboard extends CI_Controller{
    ...
    public function categoryCommonNovels(){
        $this->load->view('book_categories/CommonNovels');
    }
    public function categoryCommonSchoolEducational(){
        $this->load->view('book_categories/CommonSchoolEducational');
    }
    public function categoryCommonHigherEducational(){
        $this->load->view('book_categories/CommonHigherEducational');
    }
    public function categoryCommonMedical(){
        $this->load->view('book_categories/CommonMedical');
    }
    public function categoryCommonEnglish(){
        $this->load->view('book_categories/CommonEnglish');
    }
    public function categoryCommonTamil(){
        $this->load->view('book_categories/CommonTamil');
    }
