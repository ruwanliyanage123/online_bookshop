...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="<?php echo base_url(); ?>/assets/views/admin/img/favicon.ico">
    <!-- Google Fonts
		============================================ -->
                    ...
                    <ul class="metismenu" id="menu1">
                        <li>
                            ...
                            <ul class="submenu-angle" aria-expanded="true">
                                <li><a title="Dashboard v.1" href="index.html"><span class="mini-sub-pro">Dashboard ruwan</span></a></li>
