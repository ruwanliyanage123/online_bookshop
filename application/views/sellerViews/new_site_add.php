      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="#pablo">New Site Advertiesment</a>
          </div>
            ...
            <div class="col-md-8">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title">New Site Addvertiesment</h4>
                  <p class="card-category">Complete Addvertiesment</p>
                </div>
                <div class="card-body">
                  <form>
                    <div class="row">
                      <div class="col-md-5">
                        <div class="form-group">
                          <label class="bmd-label-floating">Bookshop</label>
                          <input type="text" class="form-control" name="bookshop" >
                        </div>
                      </div>
                      <div class="col-md-3">
                        <div class="form-group">
                          <label class="bmd-label-floating">Advertiesment Title</label>
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          <label class="bmd-label-floating">Advertiesment Type</label>
                    ...
                    <button type="submit" class="btn btn-primary pull-right">Request Advertiesment</button>
              ...
              <div class="card card-profile">
                <div class="card-body">
                  <p class="card-description">
                    load the image of the Advertiesment
                  </p>
                  <input type="file" name="prof_pic" class="btn btn-primary btn-round">
                </div>
              </div>
            </div>
          </div>
