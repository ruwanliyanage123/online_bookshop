      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="#pablo">Request New Book</a>
          </div>
            ...
            <div class="col-md-8">
              <div class="card">
                <div class="card-header card-header-primary">
                  ...
                  <p class="card-category">Complete Book Details</p>
                </div>
                <div class="card-body">
                <form action="http://localhost/online_bookshop/bookRegister/request" method="post" enctype="multipart/form-data">
                    <div class="row">
                      <div class="col-md-5">
                        <div class="form-group">
                          <label class="bmd-label-floating">ISBN Code</label>
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          <label class="bmd-label-floating">Author Id</label>
                          <input type="text" class="form-control" name="author_id" required>
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
                          <label class="bmd-label-floating">Translater</label>
                          <input type="text" class="form-control" name="translater" required>
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          <label class="bmd-label-floating" multiple>Select Category</label>
                    ...
                    <button type="submit" class="btn btn-primary pull-right">Request New Book</button>
              ...
              <div class="card card-profile">
                <div class="card-body">
                  <p class="card-description">
                    load the image of the new book
                  </p>
                  <input type="file" name="pic" class="btn btn-primary btn-round" accept=".jpg,.png,.gif">
                </div>
              </div>
            </div>
          </div>
