      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="#pablo">Seller Dashboard</a>
          </div>
        ...
        <main role="main">
            <div class="album py-5 bg-light">
                <div class="container">
                    ...
                    <!-- start of card-->
                    <?php 
                     if ($bookDeatils->num_rows() > 0 ){
                        foreach($bookDeatils->result() as $bookInfo){
                    ?>
